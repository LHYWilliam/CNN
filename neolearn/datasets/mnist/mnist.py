...
def load(normalize=True, flatten=False, one_hot_label=False):
    """读入MNIST数据集
    ...
    return classes, (dataset['train_img'], dataset['train_label']), (dataset['test_img'], dataset['test_label'])
